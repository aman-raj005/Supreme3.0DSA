...
Node* insertAtPosition(int position, int value, Node* &head, Node* &tail){ // // no need to return head if Node* insertAtPosition = void insertAtPosition ;
    ...
    return head;       // no need to return head if Node* insertAtPosition = void insertAtPosition ;
}
